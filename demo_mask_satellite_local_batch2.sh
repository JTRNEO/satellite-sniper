...
python demo_mask_batch2.py --cfg configs/faster/sniper_res101_e2e_mask_pred_satellite.yml --img_dir_path data/demo_batch/images --batch_size 1  --dataset satellite
