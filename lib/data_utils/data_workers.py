...
import mxnet as mx
import numpy as np
from nms.nms import nms_wrapper, mask_nms_wrapper
...
class mask_nms_worker(object):
    def __init__(self, nms_thresh, nms_sigma):
        self.nms_wrapper = mask_nms_wrapper(nms_thresh, nms_sigma)
...
class anchor_worker(object):
    ...
    def __init__(self, cfg, chip_size, max_n_gts=900, max_poly_len=500):
