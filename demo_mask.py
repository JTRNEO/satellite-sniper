...
import sys
sys.path.insert(0, "/home/gxdai/sniper-docker/SNIPER-mxnet/python")
import init
import matplotlib
matplotlib.use('Agg')
...
def main():
    ...
    all_detections, all_masks = tester.aggregateSingle(all_detections, all_masks, vis=True, cache_name=None, vis_path='./data/demo/',
